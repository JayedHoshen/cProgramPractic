/*This program Calculate Grade point
Id:
Name:
Grade:
*/
...
int main()
{
    studenttype student[2];//Value poribortton korte hobe akane.(2);
    int i,n=2;//n Value vari korbe (n=2);
    int marks[]={90,82};//Value poribortton korte hobe akane.
